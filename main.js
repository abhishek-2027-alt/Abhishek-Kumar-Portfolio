...
github: "https://github.com/abhishek-2027-alt/Movie-Rating-Prediction-Model.git",
      details: `
...
github: "https://github.com/abhishek-2027-alt/-Sales-Prediction-System.git",
      details: `
...
github: "https://github.com/abhishek-2027-alt/Titanic-Survival-Prediction-System.git",
      details: `
    ...
    '4': {
      title: "MovieSphere Platform",
      subtitle: "Frontend Web Development",
      tags: ["HTML5", "CSS3", "JavaScript"],
github: "https://github.com/abhishek-2027-alt/MovieSphere-Platform.git",
      details: `
        <p>A responsive movie review platform built with HTML, CSS, and JavaScript featuring an interactive UI, movie listings, and user review functionality.</p>
        <ul style="margin-left:20px; margin-top:10px; line-height:1.7; color:var(--text-secondary);">
          <li>Responsive layout with an interactive and modern user interface.</li>
          <li>Dynamic movie listings and search functionality.</li>
          <li>User review submission and rating features.</li>
        </ul>
      `
    },
};
...
background:#0F172A; border:1px solid var(--neon-pink); padding:30px;
      max-width:600px; width:100%; box-shadow:0 0 40px rgba(59,130,246,0.4);
  ...
  if (copyBtn) {
    copyBtn.addEventListener('click', () => {
      navigator.clipboard.writeText('abhishek37975@gmail.com').then(() => {
