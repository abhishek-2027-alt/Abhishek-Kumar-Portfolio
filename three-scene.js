...
const mainLight = new THREE.PointLight(0x3b82f6, 2.5, 70);
  mainLight.position.set(0, 10, 10);
  scene.add(mainLight);

const cyanLight = new THREE.PointLight(0x60a5fa, 2, 60);
  cyanLight.position.set(-15, -5, 5);
  scene.add(cyanLight);

  // --- 3D Synthwave Horizon Grid Floor ---
const gridHelper = new THREE.GridHelper(300, 80, 0x3b82f6, 0x1e293b);
...
const ring2 = new THREE.Mesh(ringGeo, new THREE.MeshBasicMaterial({ color: 0x60a5fa, wireframe: true }));
